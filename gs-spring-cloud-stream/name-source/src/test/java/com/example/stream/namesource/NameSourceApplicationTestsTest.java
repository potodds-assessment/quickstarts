...
@SpringBootTest
public class NameSourceApplicationTestsTest {
    ...
    public void testUsageDetailSender() {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
                    TestChannelBinderConfiguration.getCompleteConfiguration(NameSourceApplication.class))
                    ...
                    String name = (String)converter.fromMessage(sourceMessage, String.class);
