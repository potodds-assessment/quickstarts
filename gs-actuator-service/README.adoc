...
----
include::src/main/java/com/example/actuatorservice/ActuatorServiceApplication.java[]
----
====
...
[source,java,tabsize=2]
----
include::src/main/java/com/example/actuatorservice/Greeting.java[]
----
====
...
[source,java,tabsize=2]
----
include::src/main/java/com/example/actuatorservice/HelloWorldController.java[]
----
====
...
[source,java,tabsize=2]
----
include::src/main/java/com/example/actuatorservice/HelloWorldApplication.java[]
----
====
...
[source,java,tabsize=2]
----
include::src/test/java/com/example/actuatorservice/HelloWorldApplicationTests.java[]
----
====
