...
[source,java]
----
include::src/main/java/com/example/graphqlserver/Book.java[]
----

[source,java]
----
include::src/main/java/com/example/graphqlserver/Author.java[]
----
...
[source,java]
----
include::src/main/java/com/example/graphqlserver/BookController.java[]
----
...
[source,java]
----
include::src/test/java/com/example/graphqlserver/BookControllerTests.java[]
----
